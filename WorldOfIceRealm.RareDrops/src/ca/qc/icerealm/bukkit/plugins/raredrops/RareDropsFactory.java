	...
	public RareDropsOdds createEntityOdds(Monster monster)
	{
		...
		switch (entityId)
		{
			...
			case EntityUtilities.Spider:
			{
				...
				odds.addOddsItem(new RareDropsOddsItem(1.00 * oddsMultiplier, Material.COOKIE));
			...
			case EntityUtilities.Creeper:
			{
				...
				odds.addOddsItem(new RareDropsOddsItem(0.02 * oddsMultiplier, Material.DIAMOND_CHESTPLATE));
				odds.addOddsItem(new RareDropsOddsItem(0.02 * oddsMultiplier, Material.DIAMOND_HELMET));
				odds.addOddsItem(new RareDropsOddsItem(0.02 * oddsMultiplier, Material.DIAMOND_LEGGINGS));
				odds.addOddsItem(new RareDropsOddsItem(0.02 * oddsMultiplier, Material.DIAMOND_BOOTS));
