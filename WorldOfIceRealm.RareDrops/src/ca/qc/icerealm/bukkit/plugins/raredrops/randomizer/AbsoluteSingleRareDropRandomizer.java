...
public class AbsoluteSingleRareDropRandomizer implements RareDropsRandomizer
{
	...
	public AbsoluteSingleRareDropRandomizer()
	{
		
	}
	
	public AbsoluteSingleRareDropRandomizer(RareDropsOdds odds)
	{
		this.setOdds(odds);
	}
	...
	public ArrayList<RareDropResult> randomize()
	{
		...
		if (odds != null)
		{
			...
			{
				Collections.shuffle(odds.getOddsItems());
